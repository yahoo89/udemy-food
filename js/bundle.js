...
function calc() {
  ...
  function caclTotla() {
    ...
    if (sex === 'female') {
      result.textContent = Math.round((446.6 + (9.2 * weight) + (3.1 * height) - (4.3 * age)) * ratio);
    } else {
...
function forms(formsSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    ...
    //openModal('.modal', modalTimerId); // REMOVE !!!
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function slider({ container, slide, nextArrow, prevArrow, totalCuunter, currentCounter, wrapper, field }) {
  // SLIDER
  ...
  const
    ...
    total = document.querySelector(totalCuunter),
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-02-25');
